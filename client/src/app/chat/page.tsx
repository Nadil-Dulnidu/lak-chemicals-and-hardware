                    ...
                    <div className="flex flex-col items-center justify-center h-full gap-8">
                      ...
                      <div className="text-center space-y-3 max-w-lg">
                        ...
                        {isSignedIn && isLoaded ? (
                          ...
                          <h1 className="text-3xl font-bold tracking-tight bg-clip-text text-transparent bg-gradient-to-r from-foreground via-foreground to-orange-400">
                            Your Smart Product Assistant
                          </h1>
                        )}
